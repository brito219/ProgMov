...
public final class ItemSectionHeaderBinding implements ViewBinding {
  ...
  private ItemSectionHeaderBinding(@NonNull TextView rootView, @NonNull TextView tvSection) {
  ...
  public static ItemSectionHeaderBinding bind(@NonNull View rootView) {
    ...
    TextView tvSection = (TextView) rootView;

    return new ItemSectionHeaderBinding((TextView) rootView, tvSection);
  }
}
